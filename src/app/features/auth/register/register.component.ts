          ...
          <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="space-y-5">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="firstName" type="text" formControlName="firstName" 
                  class="block w-full px-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-orange-600 focus:ring-4 focus:ring-orange-50/50 transition-all font-medium" 
                  placeholder="Jane">
              </div>
              <div>
            ...
            <div class="text-center pt-2">
              <p class="text-slate-500 font-medium text-sm">
                ...
                <a routerLink="/auth/login" class="font-bold text-orange-600 hover:text-orange-700 hover:underline decoration-2 underline-offset-4 transition-all">Sign in here</a>
              </p>
            </div>
          </form>
        </div>
