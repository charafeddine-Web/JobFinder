...
@Component({
   ...
   template: `
    <div class="flex h-screen bg-[#F8FAFC] selection:bg-indigo-500 selection:text-white overflow-hidden relative">
      
      <!-- Background Decorative Elements -->
      <div class="fixed top-0 right-0 w-[50%] h-[50%] bg-indigo-50/50 blur-[120px] rounded-full -z-10 animate-pulse"></div>
      <div class="fixed bottom-0 left-0 w-[30%] h-[30%] bg-emerald-50/50 blur-[100px] rounded-full -z-10 animate-pulse" style="animation-delay: 2s"></div>
      ...
      <aside [class.translate-x-0]="isMobileMenuOpen()"
        ...
        <div class="h-24 flex items-center px-8">
           <a routerLink="/" class="flex items-center gap-3 group">
              <div class="w-10 h-10 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-200 rotate-[-6deg] group-hover:rotate-0 transition-all duration-500">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <a routerLink="/dashboard/applications" routerLinkActive="premium-nav-active"
            ...
            <div class="ml-auto w-5 h-5 bg-emerald-500 rounded-full flex items-center justify-center animate-pulse">
      ...
      <div class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <header class="h-20 bg-white/60 backdrop-blur-md border-b border-white lg:bg-transparent lg:border-none flex items-center justify-between px-6 lg:px-12 shrink-0 z-30">
           ...
           <div class="flex items-center gap-3">
              ...
              <button class="w-11 h-11 flex items-center justify-center bg-white rounded-xl shadow-sm border border-slate-100 text-slate-400 hover:text-indigo-600 transition-all">
                 <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
